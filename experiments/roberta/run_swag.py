...
from transformers import RobertaTokenizer, RobertaForMultipleChoice, AdamW, RobertaConfig, WEIGHTS_NAME, CONFIG_NAME
...
def main():
    ...
    # Prepare model
    model = RobertaForMultipleChoice.from_pretrained(args.bert_model)
    ...
    #if args.save_model:
    torch.save(model.state_dict(), "roberta_swag.pt")
