...
from transformers import RobertaTokenizer, RobertaForMaskedLM, Adafactor, AdamW
...
def main():
    ...
    if args.do_train:
        ...
        train_dataset = RoBERTaDataset(args.train_file, tokenizer, seq_len=args.max_seq_length,
