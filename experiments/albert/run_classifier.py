...
#from pytorch_pretrained_bert.modeling import BertForSequenceClassification, BertEmbeddings
...
#        f2 = open(os.path.join(data_dir, "dev_3783_3.tsv"), "r")
#        f3 = open(os.path.join(data_dir, "dev_3783_4.tsv"), "r")
#        f4 = open(os.path.join(data_dir, "dev_3783_2.tsv"), "r")
...
#        f = open(os.path.join(data_dir, "dev_3783_1.tsv"), "r")
...
#            print(example.guid) train-0 train-1
...
def main():
    ...
    # Prepare model
    model = AlbertForSequenceClassification.from_pretrained(args.bert_model)
    #embed=model.bert.embeddings(input_ids, segment_ids)
    if args.fp16:
        model.half()
...
#        f = open("enwiki_200000_c.txt","w", encoding="UTF-8")
