...
class TemporalProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
#dev_3783_*.tsv: 5分割交差検証用

#        f1 = open(os.path.join(data_dir, "dev_3783_5.tsv"), "r")
#        f2 = open(os.path.join(data_dir, "dev_3783_2.tsv"), "r")
#        f3 = open(os.path.join(data_dir, "dev_3783_3.tsv"), "r")
#        f4 = open(os.path.join(data_dir, "dev_3783_1.tsv"), "r")
...
#Timebank + MCTACO
#        f3 = open(os.path.join("dataset", "dev_3783_4.tsv"), "r")
#        f4 = open(os.path.join("dataset", "dev_3783_1.tsv"), "r")
#        f5 = open(os.path.join("dataset", "dev_3783_2.tsv"), "r")
#        f6 = open(os.path.join("dataset", "dev_3783_3.tsv"), "r")
#        line3 = [x.strip() for x in f3.readlines()] 
#        line4 = [x.strip() for x in f4.readlines()]
#        line5 = [x.strip() for x in f5.readlines()]
#        line6 = [x.strip() for x in f6.readlines()]
#        lines_tm = line3 + line4 + line5 + line6

#        return self._create_examples(lines, "train") + self._create_examples_temp(lines_tm, "train")

    def get_dev_examples(self, data_dir):
        f = open(os.path.join("timebank","dev.tsv"), "r")

#        f = open(os.path.join("matres","matres_test_timebank.tsv"), "r")
        lines = [x.strip() for x in f.readlines()]
        return self._create_examples(lines, "dev")
#        return self._create_examples_temp(lines, "dev")
